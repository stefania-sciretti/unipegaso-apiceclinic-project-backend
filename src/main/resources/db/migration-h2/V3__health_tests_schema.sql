...
INSERT INTO glycemia_measurement (client_id, trainer_id, measured_at, value_mg_dl, context, notes) VALUES
    (5, 1, DATEADD(DAY, -30, NOW()),  88,  'FASTING',       'Misurazione di controllo a digiuno'),
    (5, 1, DATEADD(DAY, -15, NOW()),  95,  'FASTING',       'Lieve aumento dopo festività'),
    (5, 1, DATEADD(DAY, -5,  NOW()), 140,  'POST_MEAL_2H',  'Post pranzo abbondante – nella norma'),
    (2, 1, DATEADD(DAY, -20, NOW()),  82,  'FASTING',       'Ottimo valore basale'),
    (4, 1, DATEADD(DAY, -10, NOW()), 105,  'FASTING',       'Borderline – monitorare'),
    (4, 1, DATEADD(DAY, -3,  NOW()), 165,  'POST_MEAL_1H',  'Picco glicemico post-pasto ricco di carboidrati');
